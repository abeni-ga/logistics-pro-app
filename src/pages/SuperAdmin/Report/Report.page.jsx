...
import ReportItem from "../../../components/Report/ReportItem.component.jsx";
const Report = () => {
    ...
    <div className="flex flex-col w-full h-full px-5">
      ...
      <div className="flex w-full h-[90%] gap-5 justify-end">
        <div className="flex flex-col w-[65%] gap-2">
          <div className="flex h-[10%] w-full gap-10 bg-white  rounded-lg items-center">
            <TextField
              id="outlined-select-report-data"
              select
              value={userType}
          ...
          <div className="flex h-[10%] w-full bg-gray-200 rounded-lg px-5 items-center">
            <Typography
              sx={{
                width: "20%",
                color: color.gray,
