...
const StepFour = () => {
  ...
  return (
    <div className="flex w-full h-full items-center justify-center pt-6">
      <div className="flex flex-col w-2/5 h-full rounded bg-white p-16 gap-4">
        ...
        <div className="flex flex-col gap-4 items-center justify-center">
          ...
          >
            ...
            <Typography>
              Drag and drop business registration file here
            </Typography>
