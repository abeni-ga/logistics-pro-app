      ...
      >
        <div className="flex flex-col gap-4">
          <div className="flex flex-col">
            <Typography sx={{ color: "#9CA3AF" }}>Reg No</Typography>
            <Typography>#012345678</Typography>
          </div>
          <div className="flex flex-col">
            <Typography sx={{ color: "#9CA3AF" }}>Date Registered</Typography>
            <Typography>07 Nov.2019 </Typography>
          </div>
          <div className="flex flex-col">
            <Typography sx={{ color: "#9CA3AF" }}>Subscription</Typography>
        ...
        <div className="flex flex-col justify-between">
          ...
          <div className="flex flex-col">
            <Typography sx={{ color: "#9CA3AF" }}>Reference Contact</Typography>
            <div className="flex gap-4 mb-2">
              ...
              <Typography sx={{ color: "#9CA3AF", alignSelf: "end" }}>
                CEO
              </Typography>
            </div>
          </div>
